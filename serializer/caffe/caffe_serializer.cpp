...
static bool  LoadCaffeAbsVal(StaticGraph * graph, StaticNode * node, const te_caffe::LayerParameter& layer_param)
{
...
bool CaffeSerializerRegisterOpLoader(void)
{
    ...
    p_caffe->RegisterOpLoadMethod("AbsVal",op_load_t(LoadCaffeAbsVal));
    ...
    p_buddy->RegisterOpLoadMethod("AbsVal",op_load_t(LoadCaffeAbsVal));
